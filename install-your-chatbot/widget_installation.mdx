...
- Log in to your  TelaviOneChatAI account.
...
- Once you're in the theme editor or header section, paste the script code you copied from the  TelaviOneChatAI dashboard.
