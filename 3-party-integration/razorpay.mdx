---
title: "Integrate  TelaviOneChatAI with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  TelaviOneChatAI, you will need:

- A ** TelaviOneChatAI** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  TelaviOneChatAI to collect payments via Razorpay.

#### **Step 1: Login to  TelaviOneChatAI and Select WhatsApp Bot**

1. Go to [ TelaviOneChatAI](https://www. TelaviOneChatAI.com/) and log into your account.
...
To connect Razorpay with  TelaviOneChatAI, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
5. Copy the **Client ID** and **Client Secret** from this section.

#### **Step 4: Connect Razorpay to  TelaviOneChatAI**
...
4. Go back to  TelaviOneChatAI and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  TelaviOneChatAI bot editor.
2. Select the payment chat component.
3. Add Razorpay as the payment gateway from the available options.
4. Customize the conversation flow to guide users through the payment process.

#### **Conclusion**

Your  TelaviOneChatAI WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   