---
title: "Integrate  TelaviOneChatAI with Twilio"
description: "This page provides a step-by-step guide on integration of  TelaviOneChatAI with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  TelaviOneChatAI chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  TelaviOneChatAI chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  TelaviOneChatAI with Twilio:**

#### **Step 1: Going to Integration on  TelaviOneChatAI**

1. Sign into your  TelaviOneChatAI account and choose the chatbot. Go to "Third Party Apps Integrations"
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. Copy and paste the same tokens in the  TelaviOneChatAI Applciation.
 ...
 7. Fill the Name and Request URL which is under "Voice Configuration".
    - Set the name as " TelaviOneChatAI".
    - Copy the code in  TelaviOneChatAI Twilio Integration Screen, and paste it in the Request URL box.
 8. This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  TelaviOneChatAI platform.
...
13. Note the secret keys that come up.

    <Info>
      Make sure to copy the keys as they will not appear again. Store them in a safe place
    </Info>
14. Copy the same in your  TelaviOneChatAI Account.
15. Click on update to update the integration.
16. For the final changes, go to Phone Number -\> Active Numbers, and click on the same.
17. Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  TelaviOneChatAI.
...
<AccordionGroup>
  <Accordion title="Does  TelaviOneChatAI offer SMS services with Twilio">
    No,  TelaviOneChatAI only offers Twilio with Voice calling configuration.
  </Accordion>
