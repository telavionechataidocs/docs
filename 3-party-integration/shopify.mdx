---
title: "Integrate  TelaviOneChatAI with Shopify"
description: "This page offers a step by step guide into connecting  TelaviOneChatAI with Shopify"
---
...
### **Benefits of Integrating Shopify with  TelaviOneChatAI:**

Combining Shopify through  TelaviOneChatAI allows you to:
...
### **Steps of Integration with  TelaviOneChatAI:**

 1. Log-in to your shopify account and go to the admin panel.
 2. Click on the "**Add apps**".
 3. If a pop-up screen appears, go to the bottom and click on "**Shopify App Store"**. Search for "** TelaviOneChatAI**" and click on "**Install**".

    <Info>
      If you are currently logged into  TelaviOneChatAI in another tab, be sure to log out first from there before proceeding to the next steps.
    </Info>
 4. You will be redirected to your admin panel, which will confirm the installation. Click on "**Install**" on the bottom right of the popup.
 5. Once the installation process is complete, the page will automatically redirect you to  TelaviOneChatAI, while a screen such as this appears.
 6. You will be redirected to  TelaviOneChatAI. Login to your account.
 7. Select and click the chatbot you want to integrate with Shopify. Click on the “**Third-party Apps Integration”.**
 8. Go to Shopify integration either by:
    - Searching for Shopify on the search bar available, or
    - Scrolling down to Shopify.
 9. Click on the "**Connect**" button again on the integration formation screen.
10. Click on "**Connect**" to get started.
11. You will be redirected to Shopify admin panel, which will redirect back to the  TelaviOneChatAI page, and this will confirm your integration.
...
5.Order Cancelled:**
   ...
   - Enabled using toggle.
6.Order Return Request Placed:**
   - Notifies people when a return request is placed on Shopify.
   - Enabled using toggle.
7.Order Returned(Refunded):**
   - Sends updates to customers when their return order is fulfilled.
   - Enabled using toggle.

### **FAQ's**

Here are some common FAQ's identified with Shopify integration with  TelaviOneChatAI:

<AccordionGroup>
  <Accordion title="Can I use this integration if I have multiple Shopify stores?">
    Yes, but each Shopify store should be connected to a separate bot on  TelaviOneChatAI. One bot = one store.
  </Accordion>
  ...
  <Accordion title="My bot is not connecting with Shopify. What to do?">
    If facing trouble connecting with  TelaviOneChatAI, please check the following:
    ...
    4. Make sure your WhatsApp bot is already live/published on  TelaviOneChatAI. Draft or incomplete bots may cause issues.
  </Accordion>
</AccordionGroup>
