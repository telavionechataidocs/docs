---
title: "Integrate  TelaviOneChatAI with Copper CRM"
description: "This page contains the stepwise tutorial for the integration with  TelaviOneChatAI"
---

### **Why use Copper CRM with  TelaviOneChatAI?**

 TelaviOneChatAI integrates with Copper CRM to enhance customer relationship management and automate lead nurturing processes. By syncing  TelaviOneChatAI's AI-driven chatbot with Copper CRM’s robust features, businesses can capture, qualify, and follow up with leads seamlessly. This integration ensures real-time data updates in the CRM, helping teams engage customers at the right moment with personalized responses and actions.
...
- **Personalized Customer Interactions:** Use  TelaviOneChatAI to deliver tailored messages based on customer data stored in Copper CRM.
...
### **Integrate  TelaviOneChatAI with Copper:-**

### **Step 1 of 4: Login to  TelaviOneChatAI Account and Select Application to Integrate**

1. Login to your  TelaviOneChatAI account, and select the Bot you want to integrate with Copper.
...
2.The API Token:-**
   ...
   - \
     Copy your API Key and paste It on  TelaviOneChatAI.
3.Email Address:-**
...
3. Also, your Copper integration will show the message **Installed **in the Integration List.

### **Step 4 of 4: Test your Integration Set up with Data**

Once you have established a connection between ** TelaviOneChatAI** and Copper and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  TelaviOneChatAI dashboard and the Copper you have integrated.
