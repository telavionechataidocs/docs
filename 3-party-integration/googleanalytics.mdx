---
title: "Integrate  TelaviOneChatAI with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  TelaviOneChatAI."
---

#### **Integration of Google Analytics with  TelaviOneChatAI**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  TelaviOneChatAI chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  TelaviOneChatAI:

**Step 1: Log in to  TelaviOneChatAI**

1. Navigate to your [ TelaviOneChatAI account](https://www. TelaviOneChatAI.com/).
...
To connect Google Analytics to your  TelaviOneChatAI account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  TelaviOneChatAI**

1. Go back to the  TelaviOneChatAI integration page where you clicked **Connect** for Google Analytics.
